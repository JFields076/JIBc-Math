...
1. Open `index.html` in a browser (double-click or use the browser's File > Open).
2. Or serve the folder with a simple HTTP server, e.g. `python3 -m http.server` from this folder and open http://localhost:8000

Next steps you might want:
- Replace placeholders with real images and video embeds.
- Add more pages and real content.
- Hook up a CMS or static site generator if you want templating.
